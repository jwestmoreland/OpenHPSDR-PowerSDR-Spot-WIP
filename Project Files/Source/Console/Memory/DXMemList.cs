...
namespace PowerSDR
{
    public class DXMemList
    {
        ...
        private PowerSDR.SortableBindingList<DXMemRecord> list = new PowerSDR.SortableBindingList<DXMemRecord>();

        public PowerSDR.SortableBindingList<DXMemRecord> List
        {
            get
            {
                return list;
        ...
        TextWriter writer = new StreamWriter(file_name);
            ...
            try
            {
                XmlSerializer ser = new XmlSerializer(typeof(DXMemList),
                    new Type[] { typeof(DXMemRecord), typeof(PowerSDR.SortableBindingList<DXMemRecord>), typeof(int) });
        ...
        public static DXMemList Restore1()
        {
            ...
            try
            {
                ...
                XmlSerializer ser = new XmlSerializer(typeof(DXMemList), new Type[] { typeof(DXMemRecord), typeof(PowerSDR.SortableBindingList<DXMemRecord>), typeof(int) });
